...
public class EnBorrowRequest extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_enborrowrequest);
        ...
        submitButton.setOnClickListener(v -> {
            ...
            fetchAvailableItemId(selectedItem.getId(), new OnAvailableItemFetchedListener() {
                ...
                public void onFetchFailed() {
                    ...
                    Toast.makeText(EnBorrowRequest.this, "No available item found for selected type.", Toast.LENGTH_LONG).show();
                }
            });
        });
        ...
        itemNames.add("Please select an item");
        ...
        itemSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                Toast.makeText(EnBorrowRequest.this, "Selected: " + selectedItem.getItem_name(), Toast.LENGTH_SHORT).show();
            }
    ...
    private void submitBorrowRequest(int itemId, String returnDate, String note) {
        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                ...
                runOnUiThread(() -> {
                    submitButton.setEnabled(true);
                    Toast.makeText(EnBorrowRequest.this, "Network error. Please try again.", Toast.LENGTH_LONG).show();
                });
            }
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                runOnUiThread(() -> {
                    ...
                    if (response.isSuccessful()) {
                        Toast.makeText(EnBorrowRequest.this, "Request submitted successfully!", Toast.LENGTH_LONG).show();
                    } else {
                        if (res.contains("You can only submit one equipment request per day")) {
                            Toast.makeText(EnBorrowRequest.this, "You have already submitted a request today.", Toast.LENGTH_LONG).show();
                        } else {
                            Toast.makeText(EnBorrowRequest.this, "Request failed. Try again later.", Toast.LENGTH_LONG).show();
                        }
                    }
                });
            }
    ...
    private void fetchAvailableItemId(int inventoryId, OnAvailableItemFetchedListener listener) {
        ...
        String url = MainActivity.url + "api/available-items/?inventory_id=" + inventoryId;
        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                ...
                runOnUiThread(() -> {
                    Toast.makeText(EnBorrowRequest.this, "Network error while checking availability", Toast.LENGTH_LONG).show();
            ...
            public void onResponse(Call call, Response response) throws IOException {
                if (!response.isSuccessful()) {
                    ...
                    runOnUiThread(() -> {
                        Toast.makeText(EnBorrowRequest.this, "Server error", Toast.LENGTH_LONG).show();
                        listener.onFetchFailed();
                    });
                    return;
                }
                ...
                if (availableItems.isEmpty()) {
                    runOnUiThread(() -> {
                        Toast.makeText(EnBorrowRequest.this, "No available item found for this type", Toast.LENGTH_LONG).show();
                        listener.onFetchFailed();
                    });
                } else {
    ...
    private void fetchItemsFromBackend() {
        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                runOnUiThread(() ->
                        Toast.makeText(EnBorrowRequest.this, "Failed to load items", Toast.LENGTH_SHORT).show()
                );
            }
            ...
            public void onResponse(Call call, Response response) throws IOException {
                if (response.isSuccessful()) {
                    ...
                    runOnUiThread(() -> {
                        itemNames.clear();
                        itemNames.add("Select an item"); // <--- important
                        for (InventoryItem item : inventoryList) {
                            itemNames.add(item.getItem_name());
                        }

                        ArrayAdapter<String> adapter = new ArrayAdapter<>(
                                EnBorrowRequest.this,
                                android.R.layout.simple_spinner_item,
                                itemNames
                        );
                        adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
