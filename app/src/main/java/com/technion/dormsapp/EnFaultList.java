...
public class EnFaultList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_enfaultstatus); // Reusing layout with RecyclerView
    ...
    private void fetchFaultRequests(int userId) {
        ...
        client.newCall(request).enqueue(new okhttp3.Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                runOnUiThread(() ->
                        Toast.makeText(EnFaultList.this, "Failed to load fault requests", Toast.LENGTH_SHORT).show()
                );
            }
            ...
            public void onResponse(Call call, Response response) throws IOException {
                if (response.isSuccessful()) {
                    ...
                    runOnUiThread(() ->
                            Toast.makeText(EnFaultList.this, "Server error: " + response.code(), Toast.LENGTH_SHORT).show()
                    );
                }
            }
        });
