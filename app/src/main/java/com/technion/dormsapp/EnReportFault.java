...
public class EnReportFault extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_enreportfault);
        ...
        try {
            ...
            client.newCall(request).enqueue(new Callback() {
                ...
                public void onFailure(Call call, IOException e) {
                    ...
                    runOnUiThread(() -> {
                        submitButton.setEnabled(true);
                        Toast.makeText(EnReportFault.this, "Network error. Please try again.", Toast.LENGTH_LONG).show();
                    });
                }
                ...
                public void onResponse(Call call, Response response) throws IOException {
                    ...
                    runOnUiThread(() -> {
                        ...
                        if (response.isSuccessful()) {
                            Toast.makeText(EnReportFault.this, "Fault report submitted successfully!", Toast.LENGTH_LONG).show();
                        } else {
                            if (res.contains("one fault report per day")) {
                                Toast.makeText(EnReportFault.this, "You have already submitted a fault report today.", Toast.LENGTH_LONG).show();
                            } else {
                                Toast.makeText(EnReportFault.this, "Failed to submit fault report.", Toast.LENGTH_LONG).show();
                            }
                        }
            ...
            runOnUiThread(() -> {
                submitButton.setEnabled(true);
                Toast.makeText(EnReportFault.this, "Unexpected error: " + e.getMessage(), Toast.LENGTH_LONG).show();
            });
        }
    }
