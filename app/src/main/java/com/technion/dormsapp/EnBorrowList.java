...
public class EnBorrowList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_enborrowlist);
    ...
    private void fetchBorrowedRequests(int userId) {
        ...
        client.newCall(request).enqueue(new okhttp3.Callback() {
            ...
            public void onFailure(okhttp3.Call call, IOException e) {
                runOnUiThread(() ->
                        Toast.makeText(EnBorrowList.this, "Failed to load borrowed requests", Toast.LENGTH_SHORT).show()
                );
            }
            ...
            public void onResponse(okhttp3.Call call, okhttp3.Response response) throws IOException {
                if (response.isSuccessful()) {
                    ...
                    runOnUiThread(() ->
                            Toast.makeText(EnBorrowList.this, "Server error: " + response.code(), Toast.LENGTH_SHORT).show()
                    );
                }
            }
        });
